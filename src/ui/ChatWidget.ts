...
export class ChatWidget {
    ...
    private onActionCallback?: (action: MessageAction, messageId: string) => void;
    ...
    public show(): void {
        ...
        this.panel = vscode.window.createWebviewPanel(
            'grammarProofreadingChat',
            'Grammar Proofreading Chat',
    ...
    public updateNamePromptPairs(pairs: NamePromptPair[]): void {
    ...
    public onAction(callback: (action: MessageAction, messageId: string) => void): void {
    ...
    private handlePromptButtonClick(promptName: string): void {
    ...
    private handleActionButtonClick(action: MessageAction, messageId: string): void {
