...
describe('TextProcessor - Selection Processing Properties', () => {
    ...
    describe('Property-Based Tests', () => {
        ...
        test('should send only selected text when processing selections', () => {
            ...
            fc.assert(
                fc.property(documentTextArb, selectedTextArb, (documentText, selectedText) => {
                    ...
                    vscode.window.activeTextEditor = {
                        document: {
                            ...
                            offsetAt: jest.fn().mockImplementation((position: any) => {
        ...
        test('should replace only selected portion when applying corrections', async () => {
            ...
            await fc.assert(
                fc.asyncProperty(documentTextArb, textPairArb, async (documentText, { selectedText, correctedText }) => {
        ...
        test('should handle full document processing when no selection exists', () => {
            ...
            fc.assert(
                fc.property(documentTextArb, (documentText) => {
                    fc.pre(documentText.trim().length > 0);
        ...
        test('should validate selection ranges correctly', () => {
            ...
            fc.assert(
                fc.property(documentTextArb, rangeArb, (documentText, range) => {
                    // Mock editor
                    vscode.window.activeTextEditor = {
                        document: {
        ...
        test('should handle edge cases in selection processing', () => {
            ...
            fc.assert(
                fc.property(edgeCaseArb, ({ documentText, selectedText, hasSelection }) => {
