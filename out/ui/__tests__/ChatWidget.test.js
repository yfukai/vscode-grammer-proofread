...
class ChatWidgetLogic {
    ...
    displayCorrectionRequest(promptName, text, isSelection = false) {
        const message = {
    ...
    validateMessageDistinction() {
        ...
        const areDistinguished = this.messages.every(msg => msg.type === 'user' || msg.type === 'assistant');
        return {
...
class MessageRendererLogic {
    createUserMessage(promptName, text, isSelection = false, selectionRange) {
    ...
    createAssistantMessage(correctionResponse, originalText, promptName) {
    ...
    formatCorrectionResponse(response, originalText) {
        let content = '';
    ...
    validateMessageDistinction(messages) {
        ...
        const userMessagesDistinct = userMessages.every(msg => msg.content.includes('Requesting') || msg.content.includes('correction'));
        // Assistant messages should have response-like content (emojis, analysis, etc.)
        const assistantMessagesDistinct = assistantMessages.every(msg => msg.content.includes('📝') || msg.content.includes('✏️') || msg.content.includes('🔍') ||
...
describe('Chat Widget Functionality', () => {
    ...
    describe('Property-Based Tests', () => {
        ...
        test('should display correction requests in chat widget', () => {
            ...
            fc.assert(fc.property(promptNameArb, textContentArb, isSelectionArb, (promptName, text, isSelection) => {
        ...
        test('should visually distinguish between user requests and LLM responses', () => {
            ...
            fc.assert(fc.property(promptNameArb, textContentArb, correctionResponseArb, (promptName, originalText, response) => {
                // Create user message
        ...
        test('should maintain message order and timestamps', () => {
            ...
            fc.assert(fc.property(messageCountArb, promptNameArb, textContentArb, (messageCount, promptName, text) => {
...
//# sourceMappingURL=ChatWidget.test.js.map