...
class CorrectionServiceLogic {
    extractCorrectionData(response) {
        return {
    ...
    formatExplanationMessage(response) {
    ...
    validateCorrectionWorkflow(hasValidConfig, hasActiveEditor, hasText, apiSuccess) {
        if (!hasValidConfig) {
...
describe('CorrectionService', () => {
    ...
    describe('Property-Based Tests', () => {
        ...
        test('should extract all required data from correction responses', () => {
            ...
            fc.assert(fc.property(correctionResponseArb, (response) => {
        ...
        test('should validate correction workflow prerequisites', () => {
            ...
            fc.assert(fc.property(hasValidConfigArb, hasActiveEditorArb, hasTextArb, apiSuccessArb, (hasValidConfig, hasActiveEditor, hasText, apiSuccess) => {
                const result = correctionService.validateCorrectionWorkflow(hasValidConfig, hasActiveEditor, hasText, apiSuccess);
        ...
        test('should handle empty changes array gracefully', () => {
            ...
            fc.assert(fc.property(responseWithEmptyChangesArb, (response) => {
                const message = correctionService.formatExplanationMessage(response);
                const extracted = correctionService.extractCorrectionData(response);
    ...
    describe('Unit Tests', () => {
        ...
        test('should return correct prompts for each correction type', () => {
            expect(correctionService.getPromptForCorrectionType(CorrectionType_1.CorrectionType.GRAMMAR))
                .toContain('grammatical errors');
            expect(correctionService.getPromptForCorrectionType(CorrectionType_1.CorrectionType.STYLE))
                .toContain('writing style');
            expect(correctionService.getPromptForCorrectionType(CorrectionType_1.CorrectionType.CLARITY))
                .toContain('clarity');
            expect(correctionService.getPromptForCorrectionType(CorrectionType_1.CorrectionType.TONE))
                .toContain('tone');
            expect(correctionService.getPromptForCorrectionType(CorrectionType_1.CorrectionType.CUSTOM))
                .toBe('');
        });
...
//# sourceMappingURL=CorrectionService.test.js.map